        ...
        PropertyChangeListener
{
	...
	public void publish(RowPublisher<? super T> publisher)
	{
		if (this.model == null) {
			return;
		}
		this.model.publish(publisher);
	}
	...
	public void setSelectedRowIndex(int rowIndex)
	{
		...
		this.installedTable.getSelectionModel().setSelectionInterval(rowIndex, rowIndex);
		this.installedTable.scrollRectToVisible(this.installedTable.getCellRect(rowIndex, 0, true));
	}
